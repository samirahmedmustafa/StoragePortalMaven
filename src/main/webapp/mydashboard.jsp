                    ...
                    <div class="container-fluid dashboard-content ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Highest storage capacities by storage groups (<%= (new java.text.SimpleDateFormat("dd/MM/yyyy").format(new java.util.Date())).toString()%>)</h5>
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Storage Group</th>
                                                        <th class="border-0">Total(TBs)</th>
                                                        <th class="border-0">Provisioned(TBs)</th>
                                                        <th class="border-0">Consumed(TBs)</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <c:forEach items="${controller.top10VMAX}" var = "v" begin='0' end='4'>
                                                        <tr>
                                                            <td>${v.site}</td>
                                                            <td>${v.storageGroup}</td>
                                                            <td><fmt:formatNumber value="${v.total/1024}" maxFractionDigits="2" type="number" pattern="#"/></td>
                                                            <td><fmt:formatNumber value="${v.provisioned/1024}" maxFractionDigits="2" type="number" pattern="#"/></td>
                                                            <td><fmt:formatNumber value="${v.allocated/1024}" maxFractionDigits="2" type="number" pattern="#"/> (<fmt:formatNumber value="${(v.allocated/v.provisioned)*100} " maxFractionDigits="1" type="number" pattern="#"/>%)</td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                            </table>
